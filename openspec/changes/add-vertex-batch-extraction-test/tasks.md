...
- [ ] 1.1 Create GCS bucket `emergent-batch-extraction` (requires project admin)
- [ ] 1.2 Grant Storage Object Admin to `vertex-ai-embeddings@spec-server-dev.iam.gserviceaccount.com`
...
- [ ] 4.2 Verify structured output works with batch API (requires GCS bucket)
- [ ] 4.3 Compare extraction results with LangGraph pipeline output
- [ ] 4.4 Document actual turnaround time (vs stated 24h max)

## 5. Documentation

- [x] 5.1 Add usage instructions to script header
- [x] 5.2 Document GCS bucket setup requirements (in --help)
- [ ] 5.3 Log cost comparison findings (pending actual test)
