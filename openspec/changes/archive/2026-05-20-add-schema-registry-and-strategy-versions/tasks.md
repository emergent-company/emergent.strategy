...
- [x] 2.4.1 E2E test: create artifacts → commit → publish → verify snapshot
- [x] 2.4.2 E2E test: publish v1 → modify → publish v2 → diff → verify changes
- [x] 2.4.3 E2E test: publish → restore → verify artifacts match previous state
- [x] 2.4.4 E2E test: list_versions returns correct chain
...
- [x] 3.2.8 Write unit tests with GitHub API mocks (httptest)
