...
- [ ] 1.2 Create JSON Schema for LangFuse dataset schema enforcement
- [ ] 1.3 Document dataset item structure in `docs/integrations/langfuse/EVALUATION.md`
...
- [ ] 2.5 Write unit tests for new LangfuseService methods
...
- [ ] 3.9 Write unit tests for all evaluation functions
...
- [ ] 4.6 Write integration tests for experiment runner
...
- [ ] 5.5 Document CLI usage in README
...
- [ ] 7.1 Create `docs/integrations/langfuse/EVALUATION.md` with:
  - [ ] 7.1.1 Evaluation overview and concepts
  - [ ] 7.1.2 Dataset creation guidelines
  - [ ] 7.1.3 Running experiments guide
  - [ ] 7.1.4 Interpreting scores and metrics
  - [ ] 7.1.5 Adding custom evaluators
- [ ] 7.2 Update `docs/integrations/langfuse/README.md` with evaluation section link
- [ ] 7.3 Add evaluation workflow to `CONTRIBUTING.md` for extraction changes
...
- [ ] 9.1 Add semantic relationship type similarity (TRAVELS_TO ≈ LIVED_IN)
- [ ] 9.2 Add prompt tuning to reduce LLM over-extraction
- [ ] 9.3 Expand golden dataset with more diverse examples
- [ ] 9.4 Add attribute-level evaluation metrics
