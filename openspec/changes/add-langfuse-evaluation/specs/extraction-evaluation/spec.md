...
> **Status:** Partially Implemented (as of 2025-12-07)
>
> **Implemented:**
>
> - ✅ Extraction evaluation datasets in LangFuse
> - ✅ Experiment execution with CLI (`scripts/run-extraction-experiment.ts`)
> - ✅ Entity matching with fuzzy name matching (Levenshtein similarity)
> - ✅ Relationship matching with inverse and symmetric type support
> - ✅ Precision, recall, F1, and relationship accuracy metrics
> - ✅ Seed dataset with 5 items from Book of Ruth
>
> **Experiment Results (verify-matching-improvements):**
> | Item | Entity F1 | Rel Recall | Rel F1 | Notes |
> |------|-----------|------------|--------|-------|
> | ruth-ch1-return | 0.80 | 0% | 0% | Type mismatch: TRAVELS_TO vs LIVED_IN |
> | ruth-ch1-declaration | 0.86 | N/A | N/A | No expected relationships in dataset |
> | ruth-ch4-genealogy | 0.96 | 100% | 0.39 | All relationships matched |
> | ruth-ch2-boaz | 0.83 | 100% | 0.31 | Fuzzy entity matching worked |
> | ruth-ch1-intro | 0.91 | 100% | 0.44 | Inverse + symmetric matching worked |
>
> **Remaining Gaps:**
>
> - ❌ Semantic relationship type similarity (TRAVELS_TO ≈ LIVED_IN)
> - ❌ LLM over-extraction reducing precision
> - ❌ Incomplete golden dataset (missing expected relationships)
>
> **Key Files:**
>
...
> - `scripts/run-extraction-experiment.ts`
> - `scripts/seed-extraction-evaluation-dataset.ts`
