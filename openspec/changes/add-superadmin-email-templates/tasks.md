...
- [ ] 2.6 Write unit tests for updated EmailTemplateService
...
- [ ] 3.11 Write E2E tests for all template endpoints
...
- [ ] 8.1 Write unit tests for EmailTemplate entities
- [ ] 8.2 Write unit tests for SuperadminTemplatesController
- [ ] 8.3 Write E2E tests: Superadmin can list templates
- [ ] 8.4 Write E2E tests: Superadmin can edit and save template
- [ ] 8.5 Write E2E tests: Superadmin can preview template
- [ ] 8.6 Write E2E tests: Superadmin can rollback to previous version
- [ ] 8.7 Write E2E tests: Superadmin can reset to default
- [ ] 8.8 Write E2E tests: Non-superadmin cannot access template endpoints
- [ ] 8.9 Write frontend unit tests for template hooks

## 9. Documentation

- [ ] 9.1 Update OpenAPI spec with new endpoints
- [ ] 9.2 Add template management section to superadmin guide
- [ ] 9.3 Document template variable definitions
- [ ] 9.4 Document MJML best practices for email templates
