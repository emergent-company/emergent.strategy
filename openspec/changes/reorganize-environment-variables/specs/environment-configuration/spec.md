# Environment Configuration - Spec Delta
...
**Given** a developer needs to add a new configuration variable  
**When** they consult `.env.example` files  
**Then** comments SHALL clearly indicate which file should contain the variable based on its scope  
**And** variable naming conventions SHALL be documented  
**And** example values SHALL be provided for all variables
...
None - this change reorganizes existing configuration without removing functionality.

## ADDED Requirements

None - this change reorganizes existing configuration without adding new functionality.
