...
- [ ] 7.1 Add API e2e tests for user search endpoint
- [ ] 7.2 Add API e2e tests for project members CRUD
- [ ] 7.3 Add API e2e tests for invitation accept/decline flow
- [ ] 7.4 Add frontend unit tests for SettingsLayout and SettingsSidebar
- [ ] 7.5 Add frontend unit tests for ProjectMembersPage
- [ ] 7.6 Add frontend unit tests for InviteMemberModal
- [ ] 7.7 Add Playwright e2e test for settings navigation
- [ ] 7.8 Add Playwright e2e test for full invitation flow

## 8. Documentation

- [ ] 8.1 Update API documentation with new endpoints
- [ ] 8.2 Add user guide for project member management
