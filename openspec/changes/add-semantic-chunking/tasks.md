...
- [ ] 5.4 Add integration tests for ingestion with different chunking strategies
- [ ] 5.5 Add E2E tests for POST /ingest/upload with chunking options
- [ ] 5.6 Add E2E tests for POST /ingest/url with chunking options
...
- [ ] 6.2 Add examples to ingestion endpoint descriptions
- [ ] 6.3 Document chunking strategies in `docs/features/` or relevant location
...
- [ ] 7.2 Run `nx run server:test-e2e` - E2E tests not yet run
- [x] 7.3 Run `nx run server:build` - build succeeds
- [ ] 7.4 Manual testing: verify sentence chunking preserves sentence boundaries
- [ ] 7.5 Manual testing: verify paragraph chunking preserves paragraph boundaries
