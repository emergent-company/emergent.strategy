...
## 3. Verification
- [ ] 3.1 Run new E2E test locally and verify it passes
- [ ] 3.2 Run full E2E test suite to ensure no regressions
- [ ] 3.3 Verify test runs successfully in CI environment
- [ ] 3.4 Update test documentation if needed

## 4. Documentation
- [ ] 4.1 Add comments to test file explaining each step
- [ ] 4.2 Document test requirements (demo pack must be seeded)
- [ ] 4.3 Document expected test duration (may be slow due to LLM API calls)
