...
- [ ] 10.1 User opens sidebar dropdown and sees grouped structure
- [ ] 10.2 User switches project within same org
- [ ] 10.3 User switches project to different org (verify context change)
- [ ] 10.4 Verify active project visually indicated in dropdown
- [ ] 10.5 Verify trigger shows correct project and org name
- [ ] 10.6 Test keyboard navigation (arrow keys, enter, escape)
- [ ] 10.7 Test with screen reader (ARIA labels correct)
