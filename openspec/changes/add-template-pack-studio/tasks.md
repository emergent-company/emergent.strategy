...
- [ ] 8.1 Unit tests for `TemplatePackStudioService`
- [ ] 8.2 Unit tests for schema suggestion parsing
- [ ] 8.3 API endpoint tests for studio controller
- [ ] 8.4 Frontend component tests for `TemplatePackStudio`
- [ ] 8.5 E2E test: Create new template pack via studio
- [ ] 8.6 E2E test: Edit existing template pack and save new version

## 9. Documentation

- [ ] 9.1 Add studio page to admin app routing documentation
- [ ] 9.2 Document template pack versioning model
- [ ] 9.3 Add user guide for template studio workflow
