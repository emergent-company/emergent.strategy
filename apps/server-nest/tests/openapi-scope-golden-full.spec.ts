...
const EXPECTED: Record<string, string[]> = {
    'delete /admin/extraction-jobs/projects/{projectId}/bulk-delete': ['extraction:write'],
    ...
    'get /admin/extraction-jobs/projects/{projectId}/statistics': ['extraction:read'],
    ...
    'post /admin/extraction-jobs/projects/{projectId}/bulk-cancel': ['extraction:write'],
    'post /admin/extraction-jobs/projects/{projectId}/bulk-retry': ['extraction:write'],
