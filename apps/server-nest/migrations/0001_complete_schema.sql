...
\restrict jKMNXMzEwfNT8vIdSxrL7R1afwOwVIa1tMGBrEBfDpbVc5DoETxpKcBjZ3Hp4nW
...
ALTER TABLE kb.audit_log OWNER TO spec;
...
ALTER TABLE kb.branch_lineage OWNER TO spec;
...
ALTER TABLE kb.branches OWNER TO spec;
...
ALTER TABLE kb.chat_conversations OWNER TO spec;
...
ALTER TABLE kb.chat_messages OWNER TO spec;
...
ALTER TABLE kb.clickup_sync_state OWNER TO spec;
...
ALTER TABLE kb.discovery_jobs OWNER TO spec;
...
ALTER TABLE kb.discovery_type_candidates OWNER TO spec;
...
ALTER TABLE kb.embedding_policies OWNER TO spec;
...
ALTER TABLE kb.graph_template_packs OWNER TO spec;
...
ALTER TABLE kb.integrations OWNER TO spec;
...
ALTER TABLE kb.invites OWNER TO spec;
...
ALTER TABLE kb.llm_call_logs OWNER TO spec;
...
ALTER TABLE kb.mcp_tool_calls OWNER TO spec;
...
ALTER TABLE kb.merge_provenance OWNER TO spec;
...
CREATE TABLE kb.notifications (
    ...
    category text,
    CONSTRAINT notifications_importance_check CHECK ((importance = ANY (ARRAY['important'::text, 'other'::text])))
);


ALTER TABLE kb.notifications OWNER TO spec;
...
CREATE TABLE kb.object_extraction_jobs (
    ...
    CONSTRAINT object_extraction_jobs_progress_check CHECK (((processed_items >= 0) AND (successful_items >= 0) AND (failed_items >= 0) AND (processed_items = (successful_items + failed_items)))),
    CONSTRAINT object_extraction_jobs_timing_check CHECK ((((started_at IS NULL) OR (started_at >= created_at)) AND ((completed_at IS NULL) OR ((started_at IS NOT NULL) AND (completed_at >= started_at)))))
);
...
ALTER TABLE kb.object_type_schemas OWNER TO spec;
...
ALTER TABLE kb.organization_memberships OWNER TO spec;
...
ALTER TABLE kb.orgs OWNER TO spec;
...
ALTER TABLE kb.product_version_members OWNER TO spec;
...
ALTER TABLE kb.product_versions OWNER TO spec;
...
ALTER TABLE kb.project_memberships OWNER TO spec;
...
ALTER TABLE kb.project_object_type_registry OWNER TO spec;
...
ALTER TABLE kb.project_template_packs OWNER TO spec;
...
ALTER TABLE kb.projects OWNER TO spec;
...
ALTER TABLE kb.relationship_type_schemas OWNER TO spec;
...
ALTER TABLE kb.schema_migrations OWNER TO spec;
...
ALTER TABLE kb.settings OWNER TO spec;
...
ALTER TABLE kb.system_process_logs OWNER TO spec;
...
ALTER TABLE ONLY kb.audit_log ALTER COLUMN id SET DEFAULT nextval('kb.audit_log_id_seq'::regclass);
...
CREATE INDEX idx_chat_conversations_org_proj ON kb.chat_conversations USING btree (org_id, project_id, updated_at DESC);
...
CREATE INDEX idx_documents_org ON kb.documents USING btree (org_id);
...
CREATE INDEX idx_integrations_org ON kb.integrations USING btree (org_id);
...
CREATE INDEX idx_llm_call_logs_org_timestamp ON kb.llm_call_logs USING btree (org_id, started_at DESC) WHERE (org_id IS NOT NULL);
...
CREATE INDEX idx_mcp_tool_calls_org ON kb.mcp_tool_calls USING btree (org_id, "timestamp");
...
CREATE INDEX idx_notifications_category ON kb.notifications USING btree (category) WHERE (category IS NOT NULL);
...
CREATE INDEX idx_notifications_unread_importance ON kb.notifications USING btree (user_id, importance, created_at DESC) WHERE ((read_at IS NULL) AND (cleared_at IS NULL));
...
CREATE INDEX idx_notifications_user_id ON kb.notifications USING btree (user_id) WHERE (user_id IS NOT NULL);
...
CREATE INDEX idx_object_extraction_jobs_source ON kb.object_extraction_jobs USING btree (source_type, source_id) WHERE (source_id IS NOT NULL);
...
CREATE UNIQUE INDEX idx_org_membership_unique ON kb.organization_memberships USING btree (org_id, subject_id);
...
CREATE UNIQUE INDEX idx_projects_org_lower_name ON kb.projects USING btree (org_id, lower(name));
...
CREATE INDEX idx_system_process_logs_org_timestamp ON kb.system_process_logs USING btree (org_id, "timestamp" DESC) WHERE (org_id IS NOT NULL);
...
ALTER TABLE ONLY kb.chat_conversations
    ADD CONSTRAINT chat_conversations_org_id_fkey FOREIGN KEY (org_id) REFERENCES kb.orgs(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY kb.invites
    ADD CONSTRAINT invites_org_id_fkey FOREIGN KEY (org_id) REFERENCES kb.orgs(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY kb.organization_memberships
    ADD CONSTRAINT organization_memberships_org_id_fkey FOREIGN KEY (org_id) REFERENCES kb.orgs(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY kb.projects
    ADD CONSTRAINT projects_org_id_fkey FOREIGN KEY (org_id) REFERENCES kb.orgs(id) ON DELETE CASCADE;
...
CREATE POLICY extraction_jobs_delete_policy ON kb.object_extraction_jobs FOR DELETE USING ((project_id IN ( SELECT p.id
   FROM (kb.projects p
...
CREATE POLICY extraction_jobs_insert_policy ON kb.object_extraction_jobs FOR INSERT WITH CHECK ((project_id IN ( SELECT p.id
   FROM (kb.projects p
     JOIN kb.orgs o ON ((p.org_id = o.id))))));
...
CREATE POLICY extraction_jobs_select_policy ON kb.object_extraction_jobs FOR SELECT USING ((project_id IN ( SELECT p.id
   FROM (kb.projects p
     JOIN kb.orgs o ON ((p.org_id = o.id)))
  WHERE (p.id = object_extraction_jobs.project_id))));
...
CREATE POLICY extraction_jobs_update_policy ON kb.object_extraction_jobs FOR UPDATE USING ((project_id IN ( SELECT p.id
   FROM (kb.projects p
     JOIN kb.orgs o ON ((p.org_id = o.id)))
  WHERE (p.id = object_extraction_jobs.project_id))));
...
CREATE POLICY mcp_tool_calls_tenant_isolation ON kb.mcp_tool_calls USING ((((project_id)::text = current_setting('app.current_project_id'::text, true)) OR (org_id = current_setting('app.current_org_id'::text, true))));
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.audit_log TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.branch_lineage TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.branches TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.chat_conversations TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.chat_messages TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.clickup_sync_state TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.discovery_jobs TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.discovery_type_candidates TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.embedding_policies TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.graph_template_packs TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.integrations TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.invites TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.llm_call_logs TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.mcp_tool_calls TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.merge_provenance TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.notifications TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.object_type_schemas TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.organization_memberships TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.orgs TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.product_version_members TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.product_versions TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.project_memberships TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.project_object_type_registry TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.project_template_packs TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.projects TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.relationship_type_schemas TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.schema_migrations TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.settings TO app_rls;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE kb.system_process_logs TO app_rls;
