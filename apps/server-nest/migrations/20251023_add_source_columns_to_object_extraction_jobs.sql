...
ADD COLUMN IF NOT EXISTS source_type VARCHAR(50) CHECK (
...
WHERE source_type IS NULL AND document_id IS NOT NULL;

-- Create index for efficient querying
CREATE INDEX IF NOT EXISTS idx_object_extraction_jobs_source
ON kb.object_extraction_jobs(source_type, source_id);
