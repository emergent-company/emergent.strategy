...
export abstract class BaseIntegration {
    ...
    async handleWebhook(payload: WebhookPayload): Promise<boolean> {
        ...
        this.logger.log(`Handling webhook for ${this.displayName}: ${payload.event}`);
     ...
     */
    protected async verifyWebhookSignature(payload: WebhookPayload): Promise<WebhookVerificationResult> {
