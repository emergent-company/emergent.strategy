...
export const StakeholderSchema = BaseExtractedEntitySchema.extend({
    ...
    stakeholder_type: z.enum([
        ...
        'vendor',
        'other'
    ]).optional().describe('Type of stakeholder'),

    interest_level: z.enum(['low', 'medium', 'high']).optional().describe('Level of interest in project'),

    influence_level: z.enum(['low', 'medium', 'high']).optional().describe('Level of influence over project'),

    communication_preference: z.string().optional().describe('Preferred communication method'),
    ...
    contact_info: z.string().optional().describe('Contact information if available'),
