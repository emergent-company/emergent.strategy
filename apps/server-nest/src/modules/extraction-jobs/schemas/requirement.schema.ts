...
export const RequirementSchema = BaseExtractedEntitySchema.extend({
    ...
    type: z.enum([
        ...
        'system',
        'other'
    ]).optional().describe('Type of requirement'),
    ...
    acceptance_criteria: z.string().optional().describe('Criteria for completion'),

    tags: z.array(z.string()).optional().describe('Custom tags for categorization'),
});
