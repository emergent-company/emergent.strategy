...
export const BaseExtractedEntitySchema = z.object({
     ...
     */
    source_text: z.string().optional().describe('Original text from document that supports this extraction'),

    /**
     * Additional reasoning or context from LLM about why this was extracted
     */
    extraction_reasoning: z.string().optional().describe('LLM reasoning for this extraction'),
});
