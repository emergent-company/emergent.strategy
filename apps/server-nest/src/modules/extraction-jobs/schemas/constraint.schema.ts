...
export const ConstraintSchema = BaseExtractedEntitySchema.extend({
    ...
    constraint_type: z.enum([
        ...
        'environmental',
        'other'
    ]).optional().describe('Type of constraint'),

    severity: z.enum(['low', 'medium', 'high', 'critical']).optional().describe('Impact severity'),

    is_negotiable: z.boolean().optional().describe('Whether this constraint can be negotiated'),

    impact: z.string().optional().describe('How this constraint impacts the project'),

    mitigation: z.string().optional().describe('Ways to work within or around this constraint'),
