...
export const DecisionSchema = BaseExtractedEntitySchema.extend({
    ...
    decision_type: z.enum([
        ...
        'product',
        'other'
    ]).optional().describe('Type of decision'),
    ...
    status: z.enum([
        ...
        'implemented',
        'reversed'
    ]).optional().describe('Current status of the decision'),

    priority: z.enum(['critical', 'high', 'medium', 'low']).optional().describe('Decision priority'),

    reversible: z.boolean().optional().describe('Whether this decision can be easily reversed'),
    ...
    impact_scope: z.enum([
        ...
        'organization',
        'company-wide'
    ]).optional().describe('Scope of decision impact'),

    alternatives_considered: z.string().optional().describe('Alternative options that were considered'),
