...
export class PredicateDto {
    ...
    @ApiProperty({
        ...
        enum: ['equals', 'notEquals', 'greaterThan', 'lessThan', 'greaterThanOrEqual', 'lessThanOrEqual', 'contains', 'in', 'notIn', 'matches', 'exists', 'notExists'],
        example: 'equals'
    })
    @IsIn(['equals', 'notEquals', 'greaterThan', 'lessThan', 'greaterThanOrEqual', 'lessThanOrEqual', 'contains', 'in', 'notIn', 'matches', 'exists', 'notExists'])
