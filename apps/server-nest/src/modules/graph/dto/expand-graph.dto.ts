import { ArrayMaxSize, IsArray, IsBoolean, IsIn, IsInt, IsObject, IsOptional, IsString, Matches, Max, Min, ValidateNested } from 'class-validator';
...
export class GraphExpandDto {
    ...
    @IsOptional() @IsInt() @Min(1) @Max(15000)
    ...
    @IsOptional() @ValidateNested() @Type(() => GraphExpandProjectionDto)
