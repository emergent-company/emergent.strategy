...
export class MonitoringController {
    ...
    @Scopes('extraction:read')
    @ApiOperation({ summary: 'Get extraction job details with logs and LLM calls' })
    ...
    async getExtractionJobDetail(
        ...
        try {
            return await this.monitoringService.getExtractionJobDetail(projectId, jobId);
        } catch (error: any) {
    ...
    async getExtractionJobLogs(
        ...
        return this.monitoringService.getLogsForResource(jobId, 'extraction_job', query);
    }
