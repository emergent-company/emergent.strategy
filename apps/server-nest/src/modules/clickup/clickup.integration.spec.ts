...
describe('ClickUpIntegration', () => {
    ...
    describe('Integration Metadata', () => {
        ...
        it('should return correct capabilities', () => {
            ...
            expect(capabilities.supportsOAuth).toBe(false);
    ...
    describe('Configuration', () => {
        ...
        it('should throw error if api_token is missing', async () => {
            ...
            await expect(integration.configure(invalidSettings as any)).rejects.toThrow(
                'Missing required setting: api_token'
            );
        });
        ...
        it('should throw error if workspace_id is missing', async () => {
            ...
            await expect(integration.configure(invalidSettings as any)).rejects.toThrow(
                'Missing required setting: workspace_id'
            );
        });
    });
    ...
    describe('Validation', () => {
        ...
        it('should validate configuration successfully', async () => {
            apiClient.getWorkspaces.mockResolvedValue({
                teams: [
                    { id: 'ws_123', name: 'Test Workspace', color: '#000000', avatar: null, members: [] },
                ],
            });
        ...
        it('should fail validation if workspace not found', async () => {
            apiClient.getWorkspaces.mockResolvedValue({
                teams: [
                    { id: 'ws_456', name: 'Other Workspace', color: '#000000', avatar: null, members: [] },
                ],
            });
    ...
    describe('Webhook Handling', () => {
        ...
        it('should reject webhook with invalid signature', async () => {
            ...
            await expect(
                integration.handleWebhook('int-123', 'proj-456', 'org-789', payload, 'webhook_secret')
