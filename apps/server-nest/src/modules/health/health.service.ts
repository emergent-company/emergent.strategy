...
export class HealthService {
    ...
    get() {
        ...
        if (this.db.isOnline() && typeof (this.db as any).getRlsPolicyStatus === 'function') {
            ...
            return (async () => {
                ...
                return { ...base, rls_policies_ok: rls.policies_ok, rls_policy_count: rls.count, rls_policy_hash: rls.hash };
            })();
        }
        return base;
    }
