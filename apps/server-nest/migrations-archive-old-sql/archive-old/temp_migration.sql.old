...
CREATE POLICY tags_read ON kb.tags FOR SELECT USING (
    organization_id::text = current_setting('app.current_organization_id', TRUE)
);

CREATE POLICY tags_insert ON kb.tags FOR INSERT WITH CHECK (
    organization_id::text = current_setting('app.current_organization_id', TRUE)
);

CREATE POLICY tags_update ON kb.tags FOR UPDATE USING (
    organization_id::text = current_setting('app.current_organization_id', TRUE)
);
...
CREATE TRIGGER tags_updated_at_trigger BEFORE UPDATE ON kb.tags 
...
-- ============================================================================
ALTER TABLE kb.graph_objects ADD COLUMN IF NOT EXISTS status text;
