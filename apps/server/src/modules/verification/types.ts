...
/**
 * Entity to verify (matches ExtractedEntity interface)
 */
...
export interface BatchVerificationRequest {
  ...
  /** Optional extraction job ID for tracing */
  jobId?: string;
...
/**
 * Result of verifying a description against source text
 */
export interface DescriptionVerificationResult {
  /** The description being verified */
  description: string;
  /** Whether the description was verified */
  verified: boolean;
  /** Verification status */
  status: VerificationStatus;
  /** Which tier produced the result */
...
/**
 * Result of verifying a relationship against source text
 */
export interface RelationshipVerificationResult {
  ...
  /** Existence verification confidence */
  existenceConfidence: number;
  /** Which tier verified existence */
  existenceVerificationTier: VerificationTier;
  /** Whether the relationship type is correct */
  typeVerified: boolean;
  /** Type verification confidence */
  typeConfidence: number;
  /** Which tier verified type */
  typeVerificationTier: VerificationTier;
  /** Optional description verification result */
  descriptionResult?: DescriptionVerificationResult;
  /** Overall status */
  status: VerificationStatus;
  /** Overall confidence */
  overallConfidence: number;
