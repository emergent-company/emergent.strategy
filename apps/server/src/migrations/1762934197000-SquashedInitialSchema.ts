...
export class SquashedInitialSchema1762934197000 implements MigrationInterface {
  name = 'SquashedInitialSchema1762934197000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // KB schema tables (cleaned schema - without redundant organization_id)
    await queryRunner.query(
      `CREATE TABLE "kb"."tags" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "project_id" uuid NOT NULL, "product_version_id" uuid NOT NULL, "name" text NOT NULL, "description" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_e7dc17249a1148a1970748eda99" PRIMARY KEY ("id"))`
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "kb"."product_versions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "project_id" uuid NOT NULL, "name" text NOT NULL, "description" text, "base_product_version_id" uuid, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_dbd6ab6ae9343c6c6f2df5e76db" PRIMARY KEY ("id"))`
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "kb"."object_type_schemas" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "project_id" uuid, "type" text NOT NULL, "version" integer NOT NULL DEFAULT '1', "supersedes_id" uuid, "canonical_id" uuid, "json_schema" jsonb NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_10b0ea5bce13b0404825a0c94cd" PRIMARY KEY ("id"))`
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "kb"."branches" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "project_id" uuid, "name" text NOT NULL, "parent_branch_id" uuid, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_7f37d3b42defea97f1df0d19535" PRIMARY KEY ("id"))`
    );
    ...
    // ============================================================================
    // PHASE 3: CREATE BASIC FOREIGN KEYS (from initial schema)
    // ============================================================================
    ...
    // ============================================================================
    // PHASE 4: ADD PROJECT_ID FOREIGN KEYS
    // ============================================================================
    ...
    // ============================================================================
    // PHASE 5: REVISION TRACKING - MATERIALIZED VIEWS AND FUNCTIONS
    // ============================================================================

    // Create materialized view for revision counts
    await queryRunner.query(`
    ...
    // Create function to refresh revision counts
    await queryRunner.query(`
    ...
    // Add helper function to get revision count for an object
    await queryRunner.query(`
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // Drop revision tracking components
    await queryRunner.query(
