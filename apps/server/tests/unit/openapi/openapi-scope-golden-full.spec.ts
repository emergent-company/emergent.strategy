...
const EXPECTED: Record<string, string[]> = {
  ...
  'delete /chunks': ['chunks:write'],
  'delete /chunks/by-document/{documentId}': ['chunks:write'],
  'delete /chunks/by-documents': ['chunks:write'],
  'delete /chunks/{id}': ['chunks:write'],
  ...
  'delete /user-activity/recent': ['user-activity:write'],
  'delete /user-activity/recent/{type}/{resourceId}': ['user-activity:write'],
  'get /auth/me': ['org:read'],
  'get /auth/test-passport': ['org:read'],
  'get /admin/agents': ['admin:read'],
  'get /admin/agents/{id}': ['admin:read'],
  'get /admin/agents/{id}/runs': ['admin:read'],
  ...
  'get /graph/embeddings/object/{id}/status': ['graph:read'],
  ...
  'get /user-activity/recent': ['user-activity:read'],
  'get /user-activity/recent/{type}': ['user-activity:read'],
  'patch /admin/agents/{id}': ['admin:write'],
  ...
  'post /admin/agents/{id}/trigger': ['admin:write'],
  ...
  'post /documents/{id}/recreate-chunks': ['documents:write'],
  'post /graph/branches/{targetBranchId}/merge': ['graph:write'],
  'post /graph/embedding-policies': ['graph:write'],
  'post /graph/embeddings/batch': ['graph:write'],
  'post /graph/embeddings/object/{id}': ['graph:write'],
  'post /graph/embeddings/regenerate-project': ['graph:write'],
  ...
  'post /ingest/upload-batch': ['ingest:write'],
  ...
  'post /notifications/{id}/resolve': ['notifications:write'],
  ...
  'post /tasks/{id}/cancel': ['tasks:write'],
  'post /tasks/{id}/resolve': ['tasks:write'],
  ...
  'post /user-activity/record': ['user-activity:write'],
