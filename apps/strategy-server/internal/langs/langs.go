...
var messages = map[Locale]map[string]string{
	LocaleEN: {
		...
		"nav.screen.aim":                  "AIM",
		"nav.back_to_cycle":               "Back to AIM cycle",
		"nav.back_to_step_progress":       "Back to step progress",
	...
	LocaleNB: {
		...
		"nav.screen.aim":                  "MÅL",
		"nav.back_to_cycle":               "Tilbake til MÅL-syklus",
		"nav.back_to_step_progress":       "Tilbake til stegfremdrift",
