...
## 11. Feature Definition Granularity

Before creating a feature definition, you should determine whether your functionality should be **one feature or multiple features**. This section provides a quick reference; for comprehensive guidance, see [FEATURE_DEFINITION_GRANULARITY_GUIDE.md](FEATURE_DEFINITION_GRANULARITY_GUIDE.md).

### Quick Granularity Test

Ask these 5 questions about your proposed feature:

1. **One-Sentence Test:** Can you describe it without using "and" to connect unrelated functions?
2. **User Recognition:** Would a typical user describe this as "one thing they can accomplish"?
3. **4-Persona Limit:** Can you cover all use cases with 4 personas?
4. **Capability Range:** Does it have 2-15 capabilities?
5. **Maturity Alignment:** Will all capabilities mature within 1-2 stages of each other?

**All "yes"?** → Feature is well-scoped. Proceed with creation.  
**Some "no"?** → Review the [Granularity Guide](FEATURE_DEFINITION_GRANULARITY_GUIDE.md) for splitting/combining guidance.

### Common Granularity Anti-Patterns

| Anti-Pattern | Problem | Solution |
|--------------|---------|----------|
| **UI Component Feature** | "Upload Button" is not a feature | Make it a capability in "Document Management" |
| **Technical Layer Feature** | "Database Layer" serves engineers, not users | Focus on user-facing value like "Data Export" |
| **Kitchen Sink Feature** | 25+ capabilities covering unrelated functions | Split by job-to-be-done |
| **One-Capability Feature** | Insufficient scope for full FD | Combine with related functionality |

### When Granularity Matters

- **KR Planning:** Features scoped correctly let KRs target specific capabilities
- **Maturity Tracking:** Properly-scoped features have meaningful maturity states
- **Ownership:** Good boundaries enable clear team ownership
- **User Value:** Right-sized features deliver recognizable user outcomes

For the complete decision flowchart and examples, see [FEATURE_DEFINITION_GRANULARITY_GUIDE.md](FEATURE_DEFINITION_GRANULARITY_GUIDE.md).
