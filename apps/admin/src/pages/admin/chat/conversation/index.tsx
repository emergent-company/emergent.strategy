...
import {
  ChatObjectRefs,
  parseObjectRefs,
  stripObjectRefBlocks,
} from '@/components/organisms/ChatObjectRefs';
...
export default function ChatConversationPage() {
  ...
  useEffect(() => {
    ...
    const convId =
      activeConversation?.id || initialNewConvIdRef.current || undefined;
                  ...
                  >
                    <div
                      className={`chat-bubble ${
                        m.role === 'assistant' ? 'chat-bubble-primary' : ''
                      }`}
                    >
                      {m.content ? (
                        m.role === 'assistant' ? (
                          (() => {
                            ...
                            const cleanMarkdown = stripObjectRefBlocks(
                              m.content
                            );
                                  ...
                                  <ReactMarkdown
                                    components={{
                                      ...
                                      code: ({
                                        ...
                                        return isInline ? (
                                          <code
                                            className="bg-base-300/50 px-1 py-0.5 rounded text-sm"
                                            {...props}
                                          >
                                            {children}
                                          </code>
                                          ...
                                          <code
                                            className="block bg-base-300/50 p-3 rounded-lg overflow-x-auto text-sm"
                                            {...props}
                                          >
                                            {children}
                                          </code>
                                      ...
                                      h2: ({ children, ...props }) => (
                                        <h2
                                          className="mt-3 mb-2 font-bold text-lg"
                                          {...props}
                                        >
                                          {children}
                                        </h2>
                                      ...
                                      h3: ({ children, ...props }) => (
                                        <h3
                                          className="mt-2 mb-1 font-bold text-base"
                                          {...props}
                                        >
                                          {children}
                                        </h3>
                                      ...
                                      blockquote: ({ children, ...props }) => (
                                        <blockquote
                                          className="my-2 pl-4 border-primary/30 border-l-4 italic"
                                          {...props}
                                        >
                                          {children}
                                        </blockquote>
              ...
              <div className="bottom-0 sticky bg-base-100 card-border card">
                <div className="card-body">
                  ...
                  >
                    <textarea
                      name="q"
                      className="w-full textarea textarea-md"
