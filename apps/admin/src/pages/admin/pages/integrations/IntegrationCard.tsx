            ...
            <div className="card-body">
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                            <h3 className="font-semibold truncate">{integration.displayName}</h3>
                            {isConfigured && (
                        ...
                        <p className="text-sm text-base-content/70 line-clamp-2">
                            {integration.description || `Connect to ${integration.displayName}`}
                        </p>
                    </div>
                </div>
                ...
                {configuredInstance?.error_message && (
                    <div className="mt-2 alert alert-error alert-sm">
                        ...
                        <span className="text-xs truncate">{configuredInstance.error_message}</span>
                    </div>
                )}
                ...
                <div className="justify-end mt-4 pt-4 border-t border-base-300 card-actions">
                    {isConfigured ? (
                        <>
                            ...
                            {onSync && isEnabled && integration.capabilities.supportsImport && (
                                <button
