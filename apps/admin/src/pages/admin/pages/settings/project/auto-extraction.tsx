        ...
        <div data-testid="page-settings-auto-extraction" className="mx-auto max-w-4xl container">
            ...
            <div className="mb-6">
                ...
                <p className="mt-1 text-base-content/70">
                    Configure automatic extraction of structured objects from uploaded documents
                </p>
            </div>
                ...
                <div className="space-y-6">
                            ...
                            <div className="flex justify-between items-start">
                                <div className="flex-1">
                                    ...
                                    <p className="mt-1 text-sm text-base-content/70">
                                        Automatically extract structured objects from documents when they are uploaded or updated
                                    </p>
                                </div>
                                <input
                                    type="checkbox"
                        ...
                        <>
                            ...
                            <div className="bg-base-100 border border-base-300 card">
                                <div className="card-body">
                                    ...
                                    <p className="mb-4 text-sm text-base-content/70">
                                        Minimum confidence score (0.0 - 1.0) required for extracted objects. Higher values mean more precision but may miss some objects.
                                    </p>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <label className="flex items-start gap-3 p-4 border border-base-300 hover:border-base-400 rounded-lg transition-colors cursor-pointer">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="mt-1 text-sm text-base-content/70">
                                                    Extracted objects will be marked for review before being added to the knowledge base
                                                </div>
                                            </div>
                                        </label>
                    ...
                    <div className="bg-info/10 p-4 border-info border-l-4 rounded">
                        <div className="flex gap-3">
                            ...
                            <div className="text-sm">
                                <p className="font-medium text-info">How Auto-Extraction Works</p>
                                <p className="mt-1 text-base-content/70">
                                    When a document is uploaded, the system uses AI to identify and extract structured objects based on your configuration.
                                    Extracted objects can be reviewed, edited, or approved before being added to your knowledge base.
                                </p>
                            </div>
                        </div>
                    </div>
