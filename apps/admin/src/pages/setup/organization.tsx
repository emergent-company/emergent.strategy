                    ...
                    <div className="space-y-4 card-body">
                        <div className="text-center">
                            <div className="inline-flex bg-primary/10 mb-4 p-3 rounded-full">
                                <Icon icon="lucide--building-2" className="size-8 text-primary" />
                            </div>
                        ...
                        <form onSubmit={handleCreate} className="space-y-4" data-testid="setup-org-form">
                            <div className="form-control">
                                <label className="label">
                                    <span className="font-medium label-text">Organization name</span>
                                </label>
                                <input
                                    type="text"
                            ...
                            {error && (
                                <div role="alert" className="alert alert-error" data-testid="setup-org-error">
                        ...
                        <div className="text-sm text-base-content/60 text-center">
                            <p>After creating your organization, you'll set up your first project</p>
                        </div>
                    </div>
                </div>
            </div>
