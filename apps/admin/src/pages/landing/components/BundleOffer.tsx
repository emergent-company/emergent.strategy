...
export const BundleOffer = () => {
    return (
        <div className="pt-8 md:pt-12 2xl:pt-24 xl:pt-16 pb-12 md:pb-18 2xl:pb-36 xl:pb-24 container" id="bundle">
            <div className="text-center">
                <div className="inline-flex items-center bg-purple-500/5 p-2 border border-purple-500/10 rounded-box text-purple-500">
                    <Icon icon="lucide--package-search" className="size-5" ariaLabel="Bundle" />
                </div>
                <p className="mt-4 font-semibold text-2xl sm:text-3xl">The Powerful Admin & Startup Solution</p>
            ...
            <div className="gap-6 grid lg:grid-cols-2 mt-8 lg:mt-16">
                <Link
                    ...
                    <div className="mt-5">
                        <img src="/images/landing/scalo-logo-light.svg" className="dark:hidden h-6.5" alt="Scalo" />
                        <img
                    ...
                    <div className="flex justify-center">
                        <button className="gap-3 mt-5 text-base btn btn-primary">
                            <Icon icon="lucide--plane-takeoff" className="size-4 sm:size-5" aria-hidden />
                            Get Scalo
                        </button>
                    </div>
                </Link>
                <Link
                    ...
                    <div className="bg-base-100 rounded-box">
                        <div className="relative bg-linear-to-br from-primary/5 group-hover:from-primary/10 to-secondary/5 group-hover:to-secondary/10 p-6 transition-all">
                            <p className="font-medium text-base-content/60 italic">Bundle Offer</p>
                            <div className="flex items-center gap-4 mt-5">
                                <img src="/images/logo/logo-light.svg" className="dark:hidden h-5" alt="Scalo" />
                                <img src="/images/logo/logo-dark.svg" className="hidden dark:inline h-5" alt="Scalo" />
                                <Icon icon="lucide--plus" className="size-5 text-base-content/50" aria-hidden />
                                <img
                            ...
                            <p className="mt-4 text-base-content/80">
                                Get <span className="font-semibold text-primary">Nexus Dashboard</span> and{" "}
                                <span className="font-semibold text-secondary">Scalo Startup Template</span> together at
                            ...
                            <div className="flex justify-center mt-5">
                                <button className="gap-3 bg-linear-to-br from-primary to-secondary shadow-inner shadow-primary-content/20 border-0 text-primary-content text-base btn">
                                    <Icon icon="lucide--package" className="size-4 sm:size-5" aria-hidden />
                                    Get Bundle
                                </button>
                            </div>
