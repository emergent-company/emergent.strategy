                    ...
                    <div className="flex justify-between items-center bg-base-200/30 px-5 border-b border-base-200 h-16 min-h-16">
                        ...
                        <div className="inline-flex gap-1">
                            <button
                                ...
                                onClick={reset}
                                aria-label="Reset">
                                <span className="size-5 lucide--rotate-cw iconify" />
                            ...
                            <button
                                ...
                                <span className="hidden group-data-[fullscreen]/html:inline size-5 iconify lucide--minimize" />
                                <span className="group-data-[fullscreen]/html:hidden inline size-5 iconify lucide--fullscreen" />
                            </button>
                            <label
                                htmlFor="layout-rightbar-drawer"
                                aria-label="close sidebar"
                                aria-hidden
                                className="btn btn-ghost btn-sm btn-circle">
                                <span className="size-5 iconify lucide--x" />
                            </label>
                        </div>
                    </div>
