                ...
                <div data-theme="light" className="group relative rounded-box cursor-pointer" onClick={() => changeTheme("light")}>
                    <div className="bg-base-200 pt-5 pb-3 rounded-box text-center">
                        <div className="flex justify-center items-center gap-1">
                            <span className="bg-primary rounded-box w-2 sm:w-3 h-6"></span>
                            <span className="bg-secondary rounded-box w-2 sm:w-3 h-6"></span>
                            <span className="bg-accent rounded-box w-2 sm:w-3 h-6"></span>
                            <span className="bg-success rounded-box w-2 sm:w-3 h-6"></span>
                        </div>
