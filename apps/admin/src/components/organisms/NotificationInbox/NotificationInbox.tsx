...
import type { Notification, NotificationTab, NotificationCounts } from '@/types/notification';
...
export const NotificationInbox: React.FC<NotificationInboxProps> = ({
    ...
    return (
        <div className="flex flex-col bg-base-100 border border-base-300 rounded h-full">
            ...
            {/* Notification list */}
            <div className="flex-1 overflow-y-auto" role="tabpanel" id={`${activeTab}-panel`}>
                {loading ? (
                    ...
                    <div className="flex flex-col justify-center items-center gap-3 py-16 text-center">
                        <Icon icon="lucide--inbox" className="w-12 h-12 text-base-content/30" />
