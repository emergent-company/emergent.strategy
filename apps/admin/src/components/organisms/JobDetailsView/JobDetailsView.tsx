...
export function JobDetailsView({
    ...
    return (
        <div className="z-50 fixed inset-0 bg-base-100 overflow-hidden">
            ...
            {/* Content */}
            <div className="p-6 overflow-y-auto" style={{ height: 'calc(100vh - 144px)' }}>
                {activeTab === 'summary' && (
                    <div className="space-y-6">
                        ...
                        <div className="bg-base-200 card card-compact">
                            <div className="card-body">
                                ...
                                <div className="gap-4 grid grid-cols-2 md:grid-cols-3">
                                    ...
                                    <div>
                                        <div className="text-sm text-base-content/60">Source Type</div>
                        ...
                        <div className="bg-base-200 card card-compact">
                            <div className="card-body">
                                ...
                                <div className="gap-4 grid grid-cols-2 md:grid-cols-3">
                                    <div>
                                        <div className="text-sm text-base-content/60">Started At</div>
                                        <div className="text-sm">{formatTimestamp(job.started_at)}</div>
                                    </div>
                                    <div>
                                        <div className="text-sm text-base-content/60">Completed At</div>
                                        <div className="text-sm">{formatTimestamp(job.completed_at)}</div>
                                    </div>
                                    <div>
                        ...
                        <div className="bg-base-200 card card-compact">
                            <div className="card-body">
                                ...
                                <div className="gap-4 grid grid-cols-2 md:grid-cols-4">
                                    <div>
                                        <div className="text-sm text-base-content/60">Objects Created</div>
                                        <div className="font-bold text-2xl">{job.objects_created || 0}</div>
                                    </div>
                                    <div>
                                        <div className="text-sm text-base-content/60">Relationships</div>
                                        <div className="font-bold text-2xl">
                                            {job.relationships_created || 0}
                                        </div>
                                    </div>
                                    <div>
                                        <div className="text-sm text-base-content/60">LLM Calls</div>
                                    ...
                                    <div>
                                        ...
                                        <div className="font-bold text-2xl">
                                            {formatCost(
                                                llmCalls.reduce((sum, call) => sum + (call.cost_usd || 0), 0)
                                            )}
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    <div className="card-body">
                                        <div className="flex justify-between items-start">
                                            <div>
                                                ...
                                                <div className="flex items-center gap-3 mt-1 text-xs text-base-content/60">
                                                    ...
                                                    <span className={`badge badge-xs ${call.status === 'success' ? 'badge-success' : 'badge-error'}`}>
                                                        {call.status}
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div className="gap-4 grid grid-cols-3 text-sm">
                                            <div>
                                                <div className="text-xs text-base-content/60">Input Tokens</div>
                                                <div className="font-semibold">
                                                    {call.input_tokens?.toLocaleString() || 0}
                                                </div>
                                            </div>
                                            <div>
                                                <div className="text-xs text-base-content/60">Output Tokens</div>
                                                <div className="font-semibold">
                                        ...
                                        <details className="mt-2">
                                            ...
                                            <div className="space-y-2 mt-2">
                                                <div>
                                                    <div className="mb-1 font-semibold text-xs">Request:</div>
                                                    <div className="text-xs mockup-code">
                                                        <pre>
                                                            <code>{JSON.stringify(call.request_payload, null, 2)}</code>
                                                        </pre>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div className="mb-1 font-semibold text-xs">Response:</div>
                                                    <div className="text-xs mockup-code">
                                                        <pre>
                                                            <code>{JSON.stringify(call.response_payload, null, 2)}</code>
                                                        </pre>
                                                    </div>
                                                </div>
                                            </div>
