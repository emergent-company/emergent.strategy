...
describe('ConfirmActionModal', () => {
    describe('Rendering', () => {
        ...
        it('does not render when open is false', () => {
            ...
            expect(screen.queryByRole('heading', { name: 'Should Not Appear' })).not.toBeInTheDocument()
        })
    })
    ...
    describe('Complex Scenarios', () => {
        it('handles destructive delete confirmation with error variant', () => {
            ...
            expect(screen.getByRole('heading', { name: 'Delete Project' })).toBeInTheDocument()
            expect(screen.getByText('This will permanently delete the project and all its data.')).toBeInTheDocument()
            expect(screen.getByText('All documents will be removed')).toBeInTheDocument()
