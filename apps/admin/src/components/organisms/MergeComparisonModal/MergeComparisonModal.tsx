 ...
 * Side-by-side comparison modal for merge suggestion tasks
 * Shows two objects with property diff highlighting
 */
...
/**
 * Modal that displays side-by-side comparison of two objects for merge review
 */
export const MergeComparisonModal: React.FC<MergeComparisonModalProps> = ({
  ...
  const compareProperties = useCallback((): PropertyComparison[] => {
    ...
    Array.from(allKeys)
      ...
      .forEach((key) => {
        ...
        comparisons.push({ key, sourceValue, targetValue, diff });
      });
  ...
  return (
    <dialog ref={dialogRef} className="modal" onClose={onClose}>
      <div className="modal-box max-w-6xl w-[95vw] h-[90vh] max-h-[90vh] p-0 flex flex-col">
        {/* Header */}
