...
const items: SidebarSectionProps['children'] = (
    <>
        <SidebarMenuItem id="docs" icon="lucide--file-text" url="/admin/documents">Documents</SidebarMenuItem>
        <SidebarMenuItem id="chat" icon="lucide--message-square" url="/admin/apps/chat">AI Chat</SidebarMenuItem>
        <SidebarMenuItem id="settings" icon="lucide--settings" url="/admin/settings">Settings</SidebarMenuItem>
    </>
);
