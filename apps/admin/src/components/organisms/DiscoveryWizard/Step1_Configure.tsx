    ...
    if (loading) {
        return (
            <div className="flex flex-col justify-center items-center py-12">
                ...
                <p className="mt-4 text-sm text-base-content/70">Loading documents...</p>
            </div>
        );
    }
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="mb-4 text-sm text-base-content/70">
                    Select which documents to analyze. More documents = better type discovery.
                </p>
                ...
                <div className="mt-3 text-sm text-base-content/60">
                    Selected: <span className="font-medium">{config.document_ids.length}</span> of{' '}
                    ...
                    <div className="space-y-4 pl-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    onConfigChange({ ...config, batch_size: parseInt(e.target.value) })
                                }
                            />
                        ...
                        <div>
                            <label className="label">
                                <span className="font-medium label-text">Minimum Confidence</span>
                                <span className="label-text-alt">{config.min_confidence.toFixed(2)}</span>
                            </label>
                            <input
                                type="range"
                                min="0"
                                ...
                                onChange={(e) =>
                                    onConfigChange({ ...config, min_confidence: parseFloat(e.target.value) })
                                }
                            />
                            <div className="flex justify-between mt-1 text-xs text-base-content/60">
                        ...
                        <label className="flex items-start gap-3 cursor-pointer">
                            <input
                                ...
                                onChange={(e) =>
                                    onConfigChange({ ...config, include_relationships: e.target.checked })
                                }
                            />
                            <div>
                        ...
                        <div>
                            <label className="label">
                                <span className="font-medium label-text">Max Refinement Iterations</span>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    onConfigChange({ ...config, max_iterations: parseInt(e.target.value) })
                                }
                            />
                            <div className="flex justify-between mt-1 text-xs text-base-content/60">
                                <span>Faster (1)</span>
