...
export function Step4_5_ConfigurePack({
    ...
    const handleNext = () => {
        ...
        const finalPackName = mode === 'create'
            ? packName.trim()
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="mt-1 text-sm text-base-content/70">
                    Choose whether to create a new template pack or extend an existing one.
                </p>
            </div>
            ...
            <div className="space-y-4">
                ...
                <label className="flex items-start gap-3 hover:bg-base-200 p-4 border border-base-300 rounded-lg cursor-pointer">
                    ...
                    <div className="flex-1">
                        <div className="flex items-center gap-2">
                            <Icon icon="lucide--plus-circle" className="size-5 text-primary" />
                            <span className="font-medium">Create New Pack</span>
                        </div>
                        <p className="mt-1 text-sm text-base-content/60">
                            Create a brand new template pack with the discovered types and relationships.
                        </p>
                    </div>
                </label>
                ...
                <label className="flex items-start gap-3 hover:bg-base-200 p-4 border border-base-300 rounded-lg cursor-pointer">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="mt-1 text-sm text-base-content/60">
                            Add discovered types and relationships to an existing template pack.
                        </p>
                    </div>
                </label>
            </div>
            ...
            {mode === 'extend' && (
                <div className="space-y-2">
                    <label className="label">
                        <span className="font-medium label-text">Select Pack to Extend</span>
                        <span className="label-text-alt text-error">*</span>
                    </label>
                    ...
                    {loading ? (
                        ...
                        <div className="flex flex-col justify-center items-center py-8 border border-base-300 rounded-lg text-center">
                            <Icon icon="lucide--inbox" className="size-12 text-base-content/30" />
                            <p className="mt-2 font-medium text-base-content/60">No Template Packs Found</p>
                        ...
                        <div className="space-y-2 max-h-64 overflow-y-auto">
                            {Array.isArray(existingPacks) && existingPacks.map((pack) => (
                                <label
                                    key={pack.id}
                                    className={`flex items-start gap-3 p-3 border rounded-lg cursor-pointer hover:bg-base-200 ${selectedPackId === pack.id
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm">
                        <div className="font-medium text-info">
                            {mode === 'create' ? 'Creating a New Pack' : 'Extending an Existing Pack'}
                        </div>
