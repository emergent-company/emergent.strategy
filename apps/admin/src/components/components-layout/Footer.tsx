export const Footer = () => {
    return (
        <div className="bg-base-100 px-4 md:px-8 2xl:px-20 xl:px-12 py-4 border-t border-base-300/80 border-dashed">
            <div className="flex flex-wrap justify-between items-center gap-3 px-0 w-full">
