        ...
        return (
            <div className="mx-auto mt-20 border border-base-300 max-w-lg card">
                <div className="space-y-4 card-body">
                    <h2 className="flex items-center gap-2 text-xl card-title">
                        <Icon icon="lucide--folder-plus" className="size-6" />
                        Create your first project
                    </h2>
                    <p className="opacity-80 text-sm leading-relaxed">
                        You need at least one project before you can upload documents, run chat, or search. A project
                        groups documents under an organization.
                    </p>
                    <form onSubmit={onCreate} className="space-y-3">
                        ...
                        <button className="w-full btn btn-primary" disabled={creating || name.trim().length < 2} type="submit">
                            {creating && <span className="loading loading-spinner loading-sm" />} Create project
                        </button>
                    </form>
                </div>
            </div>
