...
export const TopbarNotificationButton = () => {
    ...
    return (
        <div className="dropdown-bottom dropdown sm:dropdown-end dropdown-center">
            ...
            <div tabIndex={0} className="bg-base-100 shadow-md hover:shadow-lg mt-1 rounded-box w-84 duration-1000 dropdown-content">
                {/* Truncated content identical to original implementation */}
