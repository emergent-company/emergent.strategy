...
2. **Instance Structure Validation**
   ...
   - Framework FIRE phase (`/phases/FIRE/`) contains TEMPLATES:
...
- ❌ Feature definitions are YAML files instead of Markdown (.md)
- ❌ Feature definition files don't follow naming convention `feature_definition_{slug}.md`
- ❌ Feature definitions missing required sections (1-10)

**Green Flags (Good to go):**
- ✅ All instances follow current EPF version structure (v1.9.6)
- ✅ Instance `_meta.yaml` exists with `epf_version: "1.9.6"` matching framework
...
- ✅ Feature definitions are Markdown files with correct naming convention
- ✅ Feature definitions contain all 10 required sections
