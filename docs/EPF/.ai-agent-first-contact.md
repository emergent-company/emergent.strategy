...
### Step 2: Check Living Reality Assessment (1 minute)
...
**If exists**: Read it to understand current context, constraints, and focus.

**If not**: Collect baseline during onboarding. Ask the Quick Baseline Questions above and consider creating `living_reality_assessment.yaml` using [`templates/AIM/living_reality_assessment.yaml`](templates/AIM/living_reality_assessment.yaml) as a template.

**Skip if truly first session** - the wizard will guide initial collection naturally.
