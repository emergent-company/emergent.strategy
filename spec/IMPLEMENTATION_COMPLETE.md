...
- `spec/19-dynamic-object-graph.md` - **Authoritative spec** (3,213 lines)
- `spec/GRAPH_IMPLEMENTATION_STATUS.md` - Status summary
- `spec/GRAPH_PHASE3_ROADMAP.md` - **Future enhancements**
- `spec/20-graph-overview.md` - Human-friendly overview
...
1. Check `spec/19-dynamic-object-graph.md` for detailed specs
