...
## Migration note
The older n8n workflow exports under `spec/workflows/` are retained for reference but are no longer authoritative. New work should target these LangChain pipelines.
