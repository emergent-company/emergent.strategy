...
- **Architecture**: `spec/25-extraction-worker.md`
- **Implementation Plan**: `spec/26-extraction-worker-implementation-plan.md`
- **Type System**: `spec/24-dynamic-type-discovery-and-ingestion.md`
- **Embeddings**: `spec/20-embeddings.md` (similar pattern)
- **Graph API**: `spec/19-dynamic-object-graph.md`
