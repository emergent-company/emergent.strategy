...
The canonical list of pagination acceptance tests is tracked centrally in `spec/10-roadmap.md` (Graph Search Pagination – Tracking). Summary below for quick reference:
