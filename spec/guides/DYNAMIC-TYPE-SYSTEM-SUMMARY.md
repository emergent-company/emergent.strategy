...
1. **`spec/24-dynamic-type-discovery-and-ingestion.md`** - Complete technical specification
2. **`reference/togaf-core-template-pack.json`** - Example TOGAF template with 8 core types
3. **`spec/guides/togaf-template-quickstart.md`** - User-facing workflow guide
4. **`spec/guides/dynamic-type-system-architecture-flow.md`** - Visual architecture diagrams
