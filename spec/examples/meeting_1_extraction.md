...
This example uses the transcript at `spec/test_data/meeting_1.md` to produce structured objects (Meeting, Decisions, Requirements, ActionItems, Questions, Risks) with evidence links to chunks.
...
```json
{
  ...
  "uri": "spec/test_data/meeting_1.md",
...
Schema references
- spec/schemas/meeting.schema.json
- spec/schemas/decision.schema.json
- spec/schemas/requirement.schema.json
- spec/schemas/actionItem.schema.json
- spec/schemas/question.schema.json
- spec/schemas/risk.schema.json
