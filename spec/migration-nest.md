...
- [ ] Architectural decisions documented (in `spec/03-architecture.md`).
...
---
Generated from migration plan in `spec/03-architecture.md`; this file should be updated if scope/sequence changes.
