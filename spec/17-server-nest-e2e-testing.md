...
Purpose: Central backlog of E2E / integration test scenarios mapped against the overall product requirements (refs: `spec/02-requirements.md`, `spec/12-ai-chat.md`). We will implement these incrementally; status fields will be updated PR‑by‑PR.
